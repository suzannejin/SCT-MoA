...
p1
ggsave("results/fig/egad_recomputed+original.pdf", p1, width = 18.5, height = 9, units = 'cm')
...
p6
ggsave(paste0("results/fig/egad_", db, "_recomputed+original.pdf"), p6, width = 10, height = 7, units = 'cm')
